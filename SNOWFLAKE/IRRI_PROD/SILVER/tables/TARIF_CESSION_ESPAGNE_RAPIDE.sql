create or replace dynamic table IRRI_PROD.SILVER.TARIF_CESSION_ESPAGNE_RAPIDE(
	TYPE_COMMANDE,
	CODE_ARTICLE,
...
SELECT * FROM IRRI_PREPROD.SILVER.TARIF_CESSION_ESPAGNE_RAPIDE where conditionnement_base like '%M%';
